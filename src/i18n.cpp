...
const BuiltinTranslation kBuiltinTranslations[] = {
    ...
    { "toast.exit_edit_hint",
      L"Zweimal ESC dr\u00FCcken, um den Bearbeitungsmodus zu verlassen",
      L"Appuyez deux fois sur ESC pour quitter le mode \u00E9dition",
      L"Premi ESC due volte per uscire dalla modalit\u00E0 modifica" },
    { "toast.unsaved_exit",
