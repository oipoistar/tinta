...
const Entry kEntries[] = {
    { "toast.file_missing", L"File not found:", L"\u627e\u4e0d\u5230\u6587\u4ef6\uff1a", L"\u30d5\u30a1\u30a4\u30eb\u304c\u898b\u3064\u304b\u308a\u307e\u305b\u3093\uff1a", L"\ud30c\uc77c\uc744 \ucc3e\uc744 \uc218 \uc5c6\uc2b5\ub2c8\ub2e4:" },
    { "toast.file_no_app", L"No default app is set for this file:", L"\u672a\u8bbe\u7f6e\u6253\u5f00\u6b64\u6587\u4ef6\u7684\u9ed8\u8ba4\u5e94\u7528\uff1a", L"\u3053\u306e\u30d5\u30a1\u30a4\u30eb\u306e\u65e2\u5b9a\u306e\u30a2\u30d7\u30ea\u304c\u8a2d\u5b9a\u3055\u308c\u3066\u3044\u307e\u305b\u3093\uff1a", L"\uc774 \ud30c\uc77c\uc758 \uae30\ubcf8 \uc571\uc774 \uc124\uc815\ub418\uc5b4 \uc788\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4:" },
    { "toast.file_open_failed", L"Could not open file:", L"\u65e0\u6cd5\u6253\u5f00\u6587\u4ef6\uff1a", L"\u30d5\u30a1\u30a4\u30eb\u3092\u958b\u3051\u307e\u305b\u3093\u3067\u3057\u305f\uff1a", L"\ud30c\uc77c\uc744 \uc5f4 \uc218 \uc5c6\uc2b5\ub2c8\ub2e4:" },
    { "editor.read", L"Read \xb7 Ctrl+Shift+E", L"\u9605\u8bfb \xb7 Ctrl+Shift+E", L"\u8aad\u3080 \xb7 Ctrl+Shift+E", L"\uc77d\uae30 \xb7 Ctrl+Shift+E" },
    ...
    { "fileassoc.packaged.ask_body",
        L"Would you like to make Tinta the default viewer for Markdown, Mermaid and PlantUML files?\n\nWindows will open Settings on Tinta's page \u2014 set .md, .mmd, .puml and .plantuml to Tinta Markdown Viewer.",
        L"\u662F\u5426\u5C06 Tinta \u8BBE\u4E3A Markdown\u3001Mermaid \u548C PlantUML \u6587\u4EF6\u7684\u9ED8\u8BA4\u67E5\u770B\u5668\uFF1F\n\nWindows \u5C06\u6253\u5F00 Tinta \u7684\u8BBE\u7F6E\u9875\uFF0C\u8BF7\u5C06 .md\u3001.mmd\u3001.puml \u548C .plantuml \u8BBE\u4E3A Tinta Markdown Viewer", L"Tinta\u3092 Markdown\u3001Mermaid\u3001PlantUML \u30D5\u30A1\u30A4\u30EB\u306E\u65E2\u5B9A\u30D3\u30E5\u30FC\u30A2\u306B\u3057\u307E\u3059\u304B\uFF1F\n\nWindows \u306E\u8A2D\u5B9A\u3067 .md\u3001.mmd\u3001.puml\u3001.plantuml \u3092 Tinta Markdown Viewer \u306B\u8A2D\u5B9A\u3067\u304D\u307E\u3059\u3002", L"Tinta\uB97C Markdown, Mermaid, PlantUML \uD30C\uC77C\uC758 \uAE30\uBCF8 \uBDF0\uC5B4\uB85C \uC124\uC815\uD560\uAE4C\uC694?\n\nWindows \uC124\uC815\uC5D0\uC11C .md, .mmd, .puml, .plantuml\uC744 Tinta Markdown Viewer\uB85C \uC9C0\uC815\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4." },
    { "fileassoc.add_new_failed_body",  L"Failed to add the new file associations. Run tinta.exe /register to try again.",
                                         L"\u6DFB\u52A0\u65B0\u6587\u4EF6\u5173\u8054\u5931\u8D25\u3002\u8BF7\u8FD0\u884C tinta.exe /register \u91CD\u8BD5\u3002",
                                         L"\u65B0\u3057\u3044\u30D5\u30A1\u30A4\u30EB\u95A2\u9023\u4ED8\u3051\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F\u3002tinta.exe /register \u3092\u5B9F\u884C\u3057\u3066\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002", L"\uC0C8 \uD30C\uC77C \uC5F0\uACB0\uC744 \uCD94\uAC00\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4. tinta.exe /register\uB97C \uC2E4\uD589\uD574 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694." },
    { "fileassoc.ask_body",
        L"Would you like to set Tinta as the default viewer for Markdown, Mermaid and PlantUML files?\n\nWindows will open Settings where you can select Tinta.",
        L"\u662F\u5426\u5C06 Tinta \u8BBE\u4E3A Markdown\u3001Mermaid \u548C PlantUML \u6587\u4EF6\u7684\u9ED8\u8BA4\u67E5\u770B\u5668\uFF1F\n\nWindows \u5C06\u6253\u5F00\u8BBE\u7F6E\uFF0C\u60A8\u53EF\u5728\u5176\u4E2D\u9009\u62E9 Tinta\u3002",
         L"Tinta\u3092 Markdown\u3001Mermaid\u3001PlantUML \u30D5\u30A1\u30A4\u30EB\u306E\u65E2\u5B9A\u30D3\u30E5\u30FC\u30A2\u306B\u3057\u307E\u3059\u304B\uFF1F\n\nWindows \u306E\u8A2D\u5B9A\u3067 .md\u3001.mmd\u3001.puml\u3001.plantuml \u3092 Tinta Markdown Viewer \u306B\u8A2D\u5B9A\u3067\u304D\u307E\u3059\u3002", L"Tinta\uB97C Markdown, Mermaid, PlantUML \uD30C\uC77C\uC758 \uAE30\uBCF8 \uBDF0\uC5B4\uB85C \uC124\uC815\uD560\uAE4C\uC694?\n\nWindows \uC124\uC815\uC5D0\uC11C .md, .mmd, .puml, .plantuml\uC744 Tinta Markdown Viewer\uB85C \uC9C0\uC815\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4." },
    { "fileassoc.done_title",   L"Almost done!",                              L"\u5C31\u5FEB\u5B8C\u6210\u4E86\uFF01",                          L"\u3042\u3068\u5C11\u3057\u3067\u3059\uFF01", L"\uAC70\uC758 \uB05D\uB0AC\uC2B5\uB2C8\uB2E4!" },
    { "fileassoc.done_body",
        L"Tinta has been registered.\n\nIn the Settings window that opens:\n1. Search for '.md', '.mmd' or '.puml'\n2. Click on the current default app\n3. Select 'Tinta' from the list",
        L"Tinta \u5DF2\u6CE8\u518C\u3002\n\n\u5728\u6253\u5F00\u7684\u8BBE\u7F6E\u7A97\u53E3\u4E2D\uFF1A\n1. \u641C\u7D22 \u201C.md\u201D\u3001\u201C.mmd\u201D \u6216 \u201C.puml\u201D\n2. \u70B9\u51FB\u5F53\u524D\u9ED8\u8BA4\u5E94\u7528\n3. \u4ECE\u5217\u8868\u4E2D\u9009\u62E9 \u201CTinta\u201D",
         L"Tinta\u3092\u767B\u9332\u3057\u307E\u3057\u305F\u3002\n\n\u958B\u3044\u305F\u8A2D\u5B9A\u3067\uFF1A\n1. '.md'\u3001'.mmd' \u307E\u305F\u306F '.puml'\u3092\u691C\u7D22\n2. \u73FE\u5728\u306E\u65E2\u5B9A\u30A2\u30D7\u30EA\u3092\u30AF\u30EA\u30C3\u30AF\n3. \u4E00\u89A7\u304B\u3089 'Tinta' \u3092\u9078\u629E", L"Tinta\uB97C \uB4F1\uB85D\uD588\uC2B5\uB2C8\uB2E4.\n\n\uC5F4\uB9B0 \uC124\uC815 \uCC3D\uC5D0\uC11C:\n1. '.md', '.mmd' \uB610\uB294 '.puml' \uAC80\uC0C9\n2. \uD604\uC7AC \uAE30\uBCF8 \uC571 \uD074\uB9AD\n3. \uBAA9\uB85D\uC5D0\uC11C 'Tinta' \uC120\uD0DD" },
    ...
    { "draft.recovered", L"Restore %d unsaved draft(s)", L"\u6062\u590D %d \u4E2A\u672A\u4FDD\u5B58\u8349\u7A3F", L"\u672A\u4FDD\u5B58\u306E\u4E0B\u66F8\u304D %d \u4EF6\u3092\u5FA9\u5143", L"\uC800\uC7A5\uB418\uC9C0 \uC54A\uC740 \uCD08\uC548 %d\uAC1C \uBCF5\uC6D0" },
    { "createref.title", L"Create this file?", L"\u521B\u5EFA\u6B64\u6587\u4EF6\uFF1F", L"\u3053\u306E\u30D5\u30A1\u30A4\u30EB\u3092\u4F5C\u6210\u3057\u307E\u3059\u304B\uFF1F", L"\uC774 \uD30C\uC77C\uC744 \uB9CC\uB4E4\uAE4C\uC694?" },
    { "createref.create", L"Create", L"\u521B\u5EFA", L"\u4F5C\u6210", L"\uB9CC\uB4E4\uAE30" },
    { "createref.cancel", L"Cancel", L"\u53D6\u6D88", L"\u30AD\u30E3\u30F3\u30BB\u30EB", L"\uCDE8\uC18C" },
    { "start.tagline", L"Markdown & Mermaid, at native speed.", L"Markdown \u4E0E Mermaid\uFF0C\u539F\u751F\u901F\u5EA6\u3002", L"Markdown \u3068 Mermaid \u3092\u3001\u30CD\u30A4\u30C6\u30A3\u30D6\u306E\u901F\u3055\u3067\u3002", L"Markdown\uACFC Mermaid\uB97C \uB124\uC774\uD2F0\uBE0C \uC18D\uB3C4\uB85C." },
    { "start.open", L"Open a file", L"\u6253\u5F00\u6587\u4EF6", L"\u30D5\u30A1\u30A4\u30EB\u3092\u958B\u304F", L"\uD30C\uC77C \uC5F4\uAE30" },
    { "start.new", L"New document", L"\u65B0\u5EFA\u6587\u6863", L"\u65B0\u898F\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8", L"\uC0C8 \uBB38\uC11C" },
    { "start.browse", L"Browse", L"\u6D4F\u89C8", L"\u53C2\u7167", L"\uCC3E\uC544\uBCF4\uAE30" },
    { "start.recent", L"RECENT", L"\u6700\u8FD1", L"\u6700\u8FD1", L"\uCD5C\uADFC" },
    { "start.clear", L"clear", L"\u6E05\u9664", L"\u30AF\u30EA\u30A2", L"\uC9C0\uC6B0\uAE30" },
    { "start.learn", L"LEARN", L"\u5B66\u4E60", L"\u5B66\u3076", L"\uBC30\uC6B0\uAE30" },
    { "start.learn_sample", L"Sample document", L"\u793A\u4F8B\u6587\u6863", L"\u30B5\u30F3\u30D7\u30EB\u6587\u66F8", L"\uC0D8\uD50C \uBB38\uC11C" },
    { "start.learn_sample_d", L"Every feature in one scrollable file.", L"\u4E00\u4E2A\u6587\u4EF6\u5C55\u793A\u5168\u90E8\u529F\u80FD\u3002", L"\u5168\u6A5F\u80FD\u30921\u3064\u306E\u30D5\u30A1\u30A4\u30EB\u3067\u3002", L"\uBAA8\uB4E0 \uAE30\uB2A5\uC744 \uD55C \uD30C\uC77C\uC5D0." },
    { "start.learn_mermaid", L"Mermaid diagrams", L"Mermaid \u56FE\u8868", L"Mermaid \u56F3", L"Mermaid \uB2E4\uC774\uC5B4\uADF8\uB7A8" },
    { "start.learn_mermaid_d", L"Flowcharts, sequences and gantts from plain text.", L"\u7EAF\u6587\u672C\u7ED8\u5236\u6D41\u7A0B\u56FE\u3001\u65F6\u5E8F\u56FE\u4E0E\u7518\u7279\u56FE\u3002", L"\u30C6\u30AD\u30B9\u30C8\u304B\u3089\u30D5\u30ED\u30FC\u30C1\u30E3\u30FC\u30C8\u3084\u30AC\u30F3\u30C8\u3092\u63CF\u753B\u3002", L"\uD14D\uC2A4\uD2B8\uB85C \uC21C\uC11C\uB3C4, \uC2DC\uD000\uC2A4, \uAC04\uD2B8\uB97C \uADF8\uB9BD\uB2C8\uB2E4." },
    { "start.learn_md", L"Markdown basics", L"Markdown \u57FA\u7840", L"Markdown \u306E\u57FA\u672C", L"Markdown \uAE30\uCD08" },
    { "start.learn_md_d", L"The full syntax Tinta renders, in two minutes.", L"\u4E24\u5206\u949F\u4E86\u89E3 Tinta \u652F\u6301\u7684\u8BED\u6CD5\u3002", L"Tinta \u304C\u63CF\u753B\u3059\u308B\u5168\u8A18\u6CD5\u30922\u5206\u3067\u3002", L"Tinta\uAC00 \uB80C\uB354\uB9C1\uD558\uB294 \uBB38\uBC95\uC744 2\uBD84 \uB9CC\uC5D0." },
    { "start.shortcuts", L"All shortcuts", L"\u5168\u90E8\u5FEB\u6377\u952E", L"\u30B7\u30E7\u30FC\u30C8\u30AB\u30C3\u30C8\u4E00\u89A7", L"\uBAA8\uB4E0 \uB2E8\uCD95\uD0A4" },
    { "start.drop", L"or drop a .md / .mmd / .puml file anywhere", L"\u6216\u5C06 .md / .mmd / .puml \u6587\u4EF6\u62D6\u653E\u5230\u4EFB\u610F\u4F4D\u7F6E", L".md / .mmd / .puml \u30D5\u30A1\u30A4\u30EB\u3092\u30C9\u30ED\u30C3\u30D7\u3057\u3066\u3082\u958B\u3051\u307E\u3059", L".md / .mmd / .puml \uD30C\uC77C\uC744 \uB04C\uC5B4\uB2E4 \uB193\uC544\uB3C4 \uB429\uB2C8\uB2E4" },
    { "start.just_now", L"just now", L"\u521A\u521A", L"\u305F\u3063\u305F\u4ECA", L"\uBC29\uAE08" },
    { "start.min_ago", L"%d min ago", L"%d \u5206\u949F\u524D", L"%d \u5206\u524D", L"%d\uBD84 \uC804" },
    { "start.today", L"today", L"\u4ECA\u5929", L"\u4ECA\u65E5", L"\uC624\uB298" },
    { "start.yesterday", L"yesterday", L"\u6628\u5929", L"\u6628\u65E5", L"\uC5B4\uC81C" },
    { "start.empty", L"Files you open will appear here", L"\u6253\u5F00\u8FC7\u7684\u6587\u4EF6\u4F1A\u663E\u793A\u5728\u8FD9\u91CC", L"\u958B\u3044\u305F\u30D5\u30A1\u30A4\u30EB\u304C\u3053\u3053\u306B\u8868\u793A\u3055\u308C\u307E\u3059", L"\uC5F0 \uD30C\uC77C\uC774 \uC5EC\uAE30\uC5D0 \uD45C\uC2DC\uB429\uB2C8\uB2E4" },
    { "rail.bold", L"Bold", L"\u52A0\u7C97", L"\u592A\u5B57", L"\uAD75\uAC8C" },
    { "rail.italic", L"Italic", L"\u659C\u4F53", L"\u659C\u4F53", L"\uAE30\uC6B8\uC784" },
    { "rail.strike", L"Strikethrough", L"\u5220\u9664\u7EBF", L"\u53D6\u308A\u6D88\u3057\u7DDA", L"\uCDE8\uC18C\uC120" },
    { "rail.code", L"Inline code", L"\u884C\u5185\u4EE3\u7801", L"\u30A4\u30F3\u30E9\u30A4\u30F3\u30B3\u30FC\u30C9", L"\uC778\uB77C\uC778 \uCF54\uB4DC" },
    { "rail.link", L"Link", L"\u94FE\u63A5", L"\u30EA\u30F3\u30AF", L"\uB9C1\uD06C" },
    { "rail.bullets", L"Bullet list", L"\u65E0\u5E8F\u5217\u8868", L"\u7B87\u6761\u66F8\u304D", L"\uAE00\uBA38\uB9AC \uAE30\uD638" },
    { "rail.tasks", L"Task list", L"\u4EFB\u52A1\u5217\u8868", L"\u30BF\u30B9\u30AF\u30EA\u30B9\u30C8", L"\uC791\uC5C5 \uBAA9\uB85D" },
    { "rail.quote", L"Quote", L"\u5F15\u7528", L"\u5F15\u7528", L"\uC778\uC6A9" },
    { "rail.table", L"Insert table", L"\u63D2\u5165\u8868\u683C", L"\u8868\u3092\u633F\u5165", L"\uD45C \uC0BD\uC785" },
    { "rail.diagram", L"Insert diagram", L"\u63D2\u5165\u56FE\u8868", L"\u56F3\u3092\u633F\u5165", L"\uB2E4\uC774\uC5B4\uADF8\uB7A8 \uC0BD\uC785" },
    { "rail.image", L"Insert image", L"\u63D2\u5165\u56FE\u7247", L"\u753B\u50CF\u3092\u633F\u5165", L"\uC774\uBBF8\uC9C0 \uC0BD\uC785" },
    { "help.edit.mode", L"WYSIWYG / raw markdown", L"\u6240\u89C1\u5373\u6240\u5F97 / \u539F\u59CB Markdown", L"WYSIWYG / Raw Markdown", L"WYSIWYG / \uC6D0\uC2DC \uB9C8\uD06C\uB2E4\uC6B4" },
    { "fm.section", L"Frontmatter", nullptr, nullptr, nullptr },
    { "fm.title", L"Frontmatter properties", nullptr, nullptr, nullptr },
    { "fm.strip_hint", L"Show YAML properties above the document", nullptr, nullptr, nullptr },
    { "fm.hidden", L"Hidden", nullptr, nullptr, nullptr },
    { "fm.shown", L"Shown", nullptr, nullptr, nullptr },
    { "fm.save_hint", L"Show created / updated to add and maintain them on save.", nullptr, nullptr, nullptr },
    { "fm.key", L"KEY", nullptr, nullptr, nullptr },
    { "fm.show", L"SHOW", nullptr, nullptr, nullptr },
    { "fm.side", L"SIDE", nullptr, nullptr, nullptr },
    { "fm.label", L"LABEL", nullptr, nullptr, nullptr },
    { "fm.format", L"FORMAT", nullptr, nullptr, nullptr },
    { "fm.other", L"Any new key discovered in documents", nullptr, nullptr, nullptr },
    { "fm.preview", L"PREVIEW", nullptr, nullptr, nullptr },
    { "fm.hidden_preview", L"The property strip is hidden.", nullptr, nullptr, nullptr },
    { "fm.plain", L"Plain", nullptr, nullptr, nullptr },
    { "fm.large", L"Large text", nullptr, nullptr, nullptr },
    { "fm.absolute", L"Jan 3, 2026", nullptr, nullptr, nullptr },
    { "fm.relative", L"Relative date", nullptr, nullptr, nullptr },
    { "fm.chips", L"Chips", nullptr, nullptr, nullptr },
    { "fm.hashtags", L"#hashtags", nullptr, nullptr, nullptr },
    { "fm.comma", L"Comma list", nullptr, nullptr, nullptr },
    { "fm.count", L"Count only", nullptr, nullptr, nullptr },
    { "fm.up_to", L"Show up to", nullptr, nullptr, nullptr },
    ...
    { "settings.plantuml", L"PlantUML diagrams", L"PlantUML \u56fe\u8868", L"PlantUML \u56f3", L"PlantUML \ub2e4\uc774\uc5b4\uadf8\ub7a8" },
    { "settings.plantuml.hint", L"Point at plantuml.exe or java's plantuml.jar to render diagrams", L"\u6307\u5411 plantuml.exe \u6216 java \u7684 plantuml.jar \u4ee5\u6e32\u67d3\u56fe\u8868", L"plantuml.exe \u307e\u305f\u306f java \u306e plantuml.jar \u3092\u6307\u5b9a\u3057\u3066\u56f3\u3092\u63cf\u753b\u3057\u307e\u3059", L"plantuml.exe \ub610\ub294 java\uc758 plantuml.jar\ub97c \uc9c0\uc815\ud558\uba74 \ub2e4\uc774\uc5b4\uadf8\ub7a8\uc744 \ub80c\ub354\ub9c1\ud569\ub2c8\ub2e4" },
    { "ectx.cut", L"Cut", L"\u526A\u5207", L"\u5207\u308A\u53D6\u308A", L"\uC798\uB77C\uB0B4\uAE30" },
    { "ectx.copy", L"Copy", L"\u590D\u5236", L"\u30B3\u30D4\u30FC", L"\uBCF5\uC0AC" },
    { "ectx.paste", L"Paste", L"\u7C98\u8D34", L"\u8CBC\u308A\u4ED8\u3051", L"\uBD99\uC5EC\uB123\uAE30" },
    { "ectx.insert", L"INSERT", L"\u63D2\u5165", L"\u633F\u5165", L"\uC0BD\uC785" },
    { "ectx.table", L"Table", L"\u8868\u683C", L"\u8868", L"\uD45C" },
    { "ectx.diagram", L"Diagram", L"\u56FE\u8868", L"\u56F3", L"\uB2E4\uC774\uC5B4\uADF8\uB7A8" },
    { "ectx.image", L"Image", L"\u56FE\u7247", L"\u753B\u50CF", L"\uC774\uBBF8\uC9C0" },
    { "ectx.codeblock", L"Code block", L"\u4EE3\u7801\u5757", L"\u30B3\u30FC\u30C9\u30D6\u30ED\u30C3\u30AF", L"\uCF54\uB4DC \uBE14\uB85D" },
    { "ectx.link", L"Link", L"\u94FE\u63A5", L"\u30EA\u30F3\u30AF", L"\uB9C1\uD06C" },
    { "ectx.hr", L"Horizontal rule", L"\u5206\u9694\u7EBF", L"\u6C34\u5E73\u7DDA", L"\uC218\uD3C9\uC120" },
    { "ectx.wysiwyg", L"Edit in WYSIWYG", L"\u4EE5\u6240\u89C1\u5373\u6240\u5F97\u7F16\u8F91", L"WYSIWYG \u3067\u7DE8\u96C6", L"WYSIWYG\uB85C \uD3B8\uC9D1" },
    { "ectx.templates", L"MERMAID TEMPLATES", L"MERMAID \u6A21\u677F", L"MERMAID \u30C6\u30F3\u30D7\u30EC\u30FC\u30C8", L"MERMAID \uD15C\uD50C\uB9BF" },
    { "ectx.table_word", L"table", L"\u8868\u683C", L"\u8868", L"\uD45C" },
    { "ectx.d.flow", L"Flowchart", L"\u6D41\u7A0B\u56FE", L"\u30D5\u30ED\u30FC\u30C1\u30E3\u30FC\u30C8", L"\uC21C\uC11C\uB3C4" },
    { "ectx.d.seq", L"Sequence", L"\u65F6\u5E8F\u56FE", L"\u30B7\u30FC\u30B1\u30F3\u30B9", L"\uC2DC\uD000\uC2A4" },
    { "ectx.d.class", L"Class", L"\u7C7B\u56FE", L"\u30AF\u30E9\u30B9", L"\uD074\uB798\uC2A4" },
    { "ectx.d.state", L"State", L"\u72B6\u6001\u56FE", L"\u30B9\u30C6\u30FC\u30C8", L"\uC0C1\uD0DC" },
    { "ectx.d.gantt", L"Gantt", L"\u7518\u7279\u56FE", L"\u30AC\u30F3\u30C8", L"\uAC04\uD2B8" },
    { "ectx.d.pie", L"Pie", L"\u997C\u56FE", L"\u5186\u30B0\u30E9\u30D5", L"\uD30C\uC774" },
    { "ectx.d.empty", L"Empty block", L"\u7A7A\u767D\u5757", L"\u7A7A\u306E\u30D6\u30ED\u30C3\u30AF", L"\uBE48 \uBE14\uB85D" },
    { "ectx.d.puml_seq", L"PUML Sequence", L"PUML \u65F6\u5E8F\u56FE", L"PUML \u30B7\u30FC\u30B1\u30F3\u30B9", L"PUML \uC2DC\uD000\uC2A4" },
    { "ectx.d.puml_class", L"PUML Class", L"PUML \u7C7B\u56FE", L"PUML \u30AF\u30E9\u30B9", L"PUML \uD074\uB798\uC2A4" },
    { "ectx.d.puml_act", L"PUML Activity", L"PUML \u6D3B\u52A8\u56FE", L"PUML \u30A2\u30AF\u30C6\u30A3\u30D3\u30C6\u30A3", L"PUML \uD65C\uB3C5" },
    ...
    { "empty.hint1", L"Markdown (.md), Mermaid (.mmd) and PlantUML (.puml) files \u2014 or", L"Markdown (.md)\u3001Mermaid (.mmd) \u548C PlantUML (.puml) \u6587\u4EF6\uFF0C\u6216", L"Markdown (.md)\u3001Mermaid (.mmd)\u3001PlantUML (.puml) \u30D5\u30A1\u30A4\u30EB \u2014 \u307E\u305F\u306F", L"Markdown (.md), Mermaid (.mmd), PlantUML (.puml) \uD30C\uC77C \u2014 \uB610\uB294" },
    ...
    { "help.view.new_tab", L"New tab (start page)", L"\u65B0\u5EFA\u6807\u7B7E\u9875\uFF08\u8D77\u59CB\u9875\uFF09", L"\u65B0\u3057\u3044\u30BF\u30D6\uFF08\u30B9\u30BF\u30FC\u30C8\u30DA\u30FC\u30B8\uFF09", L"\uC0C8 \uD0ED (\uC2DC\uC791 \uD398\uC774\uC9C0)" },
    ...
    { "settings.heading_rules", L"Heading separators", L"\u6807\u9898\u5206\u9694\u7EBF", L"\u898B\u51FA\u3057\u306E\u533A\u5207\u308A\u7DDA", L"\uC81C\uBAA9 \uAD6C\uBD84\uC120" },
    { "settings.heading_rules.hint", L"Draw a line under level 1 and 2 headings", L"\u5728\u4E00\u7EA7\u548C\u4E8C\u7EA7\u6807\u9898\u4E0B\u65B9\u7ED8\u5236\u6A2A\u7EBF", L"\u30EC\u30D9\u30EB1\u30682\u306E\u898B\u51FA\u3057\u306E\u4E0B\u306B\u7DDA\u3092\u5F15\u304F", L"1\uB2E8\uACC4\uC640 2\uB2E8\uACC4 \uC81C\uBAA9 \uC544\uB798\uC5D0 \uC120\uC744 \uADF8\uB9BD\uB2C8\uB2E4" },
    { "signal.notifications", L"Notifications", L"\u901A\u77E5", L"\u901A\u77E5", L"\uC54C\uB9BC" },
    { "signal.clear_all", L"Clear all", L"\u5168\u90E8\u6E05\u9664", L"\u3059\u3079\u3066\u30AF\u30EA\u30A2", L"\uBAA8\uB450 \uC9C0\uC6B0\uAE30" },
    { "signal.parked", L"Dismissed chips park here, nothing is lost", L"\u5DF2\u5173\u95ED\u7684\u63D0\u793A\u4FDD\u5B58\u5728\u8FD9\u91CC\uFF0C\u4E0D\u4F1A\u4E22\u5931", L"\u9589\u3058\u305F\u901A\u77E5\u306F\u3053\u3053\u306B\u6B8B\u308A\u307E\u3059", L"\uB2EB\uC740 \uC54C\uB9BC\uC740 \uC5EC\uAE30\uC5D0 \uBCF4\uAD00\uB429\uB2C8\uB2E4" },
    { "signal.pinned", L"PINNED", L"\u5DF2\u56FA\u5B9A", L"\u56FA\u5B9A", L"\uACE0\uC815\uB428" },
    { "signal.held", L"HELD", L"\u5DF2\u6682\u505C", L"\u4FDD\u6301\u4E2D", L"\uC720\uC9C0 \uC911" },
    { "signal.restore", L"Restore", L"\u6062\u590D", L"\u5FA9\u5143", L"\uBCF5\uC6D0" },
    { "signal.retry", L"Retry", L"\u91CD\u8BD5", L"\u518D\u8A66\u884C", L"\uB2E4\uC2DC \uC2DC\uB3C4" },
    { "signal.stays", L"stays until answered", L"\u4FDD\u6301\u663E\u793A\u76F4\u5230\u786E\u8BA4", L"\u5FDC\u7B54\u3059\u308B\u307E\u3067\u8868\u793A", L"\uC751\uB2F5\uD560 \uB54C\uAE4C\uC9C0 \uC720\uC9C0" },
    { "toc.hint", L"Follows your scroll \u00B7 click jumps", L"\u8DDF\u968F\u6EDA\u52A8 \u00B7 \u70B9\u51FB\u8DF3\u8F6C", L"\u30B9\u30AF\u30ED\u30FC\u30EB\u306B\u8FFD\u5F93 \u00B7 \u30AF\u30EA\u30C3\u30AF\u3067\u79FB\u52D5", L"\uC2A4\uD06C\uB864 \uB530\uB77C\uAC10 \u00B7 \uD074\uB9AD\uC73C\uB85C \uC774\uB3D9" },
    { "browser.folders", L"FOLDERS", L"\u6587\u4EF6\u5939", L"\u30D5\u30A9\u30EB\u30C0\u30FC", L"\uD3F4\uB354" },
    { "browser.files", L"FILES", L"\u6587\u4EF6", L"\u30D5\u30A1\u30A4\u30EB", L"\uD30C\uC77C" },
    { "browser.counts", L"%d folders \u00B7 %d files", L"%d \u4E2A\u6587\u4EF6\u5939 \u00B7 %d \u4E2A\u6587\u4EF6", L"\u30D5\u30A9\u30EB\u30C0\u30FC %d \u00B7 \u30D5\u30A1\u30A4\u30EB %d", L"\uD3F4\uB354 %d \u00B7 \uD30C\uC77C %d" },
    { "browser.hint", L"Enter opens \u00B7 Backspace up", L"Enter \u6253\u5F00 \u00B7 Backspace \u8FD4\u56DE\u4E0A\u7EA7", L"Enter\u3067\u958B\u304F \u00B7 Backspace\u3067\u4E0A\u3078", L"Enter \uC5F4\uAE30 \u00B7 Backspace \uC704\uB85C" },
    { "browser.naming_folder", L"Naming new folder\u2026", L"\u6B63\u5728\u547D\u540D\u65B0\u6587\u4EF6\u5939\u2026", L"\u65B0\u3057\u3044\u30D5\u30A9\u30EB\u30C0\u30FC\u306B\u547D\u540D\u4E2D\u2026", L"\uC0C8 \uD3F4\uB354 \uC774\uB984 \uC785\uB825 \uC911\u2026" },
    { "browser.naming_file", L"Naming new file\u2026", L"\u6B63\u5728\u547D\u540D\u65B0\u6587\u4EF6\u2026", L"\u65B0\u3057\u3044\u30D5\u30A1\u30A4\u30EB\u306B\u547D\u540D\u4E2D\u2026", L"\uC0C8 \uD30C\uC77C \uC774\uB984 \uC785\uB825 \uC911\u2026" },
    { "browser.naming_hint", L"Enter creates \u00B7 Esc cancels", L"Enter \u521B\u5EFA \u00B7 Esc \u53D6\u6D88", L"Enter\u3067\u4F5C\u6210 \u00B7 Esc\u3067\u53D6\u6D88", L"Enter \uB9CC\uB4E4\uAE30 \u00B7 Esc \uCDE8\uC18C" },
...
const BuiltinTranslation kBuiltinTranslations[] = {
    ...
    { "fileassoc.packaged.ask_body",
      L"M\u00F6chten Sie Tinta als Standardanzeige f\u00FCr Markdown-, Mermaid- und PlantUML-Dateien festlegen?\n\nWindows \u00F6ffnet die Tinta-Seite in den Einstellungen. Setzen Sie dort .md, .mmd, .puml und .plantuml auf Tinta Markdown Viewer.",
      L"Voulez-vous d\u00E9finir Tinta comme visionneuse par d\u00E9faut des fichiers Markdown, Mermaid et PlantUML ?\n\nWindows ouvrira la page de Tinta dans les Param\u00E8tres. D\u00E9finissez .md, .mmd, .puml et .plantuml sur Tinta Markdown Viewer.",
      L"Vuoi impostare Tinta come visualizzatore predefinito per i file Markdown, Mermaid e PlantUML?\n\nWindows aprir\u00E0 la pagina di Tinta nelle Impostazioni. Imposta .md, .mmd, .puml e .plantuml su Tinta Markdown Viewer." },
    { "fileassoc.add_new_failed_body",
      L"Die neuen Dateizuordnungen konnten nicht hinzugef\u00FCgt werden. F\u00FChren Sie tinta.exe /register aus, um es erneut zu versuchen.",
      L"Impossible d'ajouter les nouvelles associations de fichiers. Ex\u00E9cutez tinta.exe /register pour r\u00E9essayer.",
      L"Impossibile aggiungere le nuove associazioni di file. Esegui tinta.exe /register per riprovare." },
    { "fileassoc.ask_body",
    ...
    { "empty.open_button",
      ...
      L"Apri un file" },
    { "empty.hint1",
      L"Markdown-, Mermaid- und PlantUML-Dateien (.md, .mmd, .puml) \u2014 oder",
      L"Fichiers Markdown, Mermaid et PlantUML (.md, .mmd, .puml) \u2014 ou",
      L"File Markdown, Mermaid e PlantUML (.md, .mmd, .puml) \u2014 oppure" },
    { "empty.hint2",
    ...
    { "settings.plantuml",
      L"PlantUML-Diagramme",
      L"Diagrammes PlantUML",
      L"Diagrammi PlantUML" },
    { "settings.plantuml.hint",
      L"Auf plantuml.exe oder die plantuml.jar von Java zeigen, um Diagramme zu rendern",
      L"Indiquez plantuml.exe ou le plantuml.jar de Java pour afficher les diagrammes",
      L"Indica plantuml.exe o il plantuml.jar di Java per visualizzare i diagrammi" },
    { "ectx.d.puml_seq",
      L"PUML-Sequenz",
      L"S\u00E9quence PUML",
      L"Sequenza PUML" },
    ...
    { "help.view.new_tab",
      L"Neuer Tab (Startseite)",
      L"Nouvel onglet (page d'accueil)",
      L"Nuova scheda (pagina iniziale)" },
    { "help.view.next_tab",
      L"N\u00E4chster Tab",
      L"Onglet suivant",
      L"Scheda successiva" },
    ...
    { "tabs.switcher.header",
      ...
      L"FICHIERS OUVERTS",
      L"FILE APERTI" },
    { "settings.heading_rules",
      L"Trennlinien unter \u00DCberschriften",
      L"S\u00E9parateurs de titres",
      L"Separatori dei titoli" },
    { "settings.heading_rules.hint",
      L"Linie unter \u00DCberschriften der Ebenen 1 und 2 zeichnen",
      L"Trace une ligne sous les titres de niveau 1 et 2",
      L"Traccia una linea sotto i titoli di livello 1 e 2" },
    ...
    { "signal.clear_all",
      ...
      L"Cancella tutto" },
    { "signal.parked",
      L"Geschlossene Hinweise landen hier, nichts geht verloren",
      L"Les notifications ferm\u00E9es restent ici, rien n'est perdu",
      L"Le notifiche chiuse restano qui, nulla va perso" },
    { "signal.pinned",
      L"ANGEHEFTET",
      L"\u00C9PINGL\u00C9",
      L"FISSATO" },
    ...
    { "signal.retry",
      ...
      L"Riprova" },
    { "signal.stays",
      L"bleibt bis zur Antwort",
      L"reste jusqu'\u00E0 la r\u00E9ponse",
      L"resta finch\u00E9 non rispondi" },
    { "toc.hint",
      L"Folgt dem Scrollen \u00B7 Klick springt",
      L"Suit le d\u00E9filement \u00B7 clic pour sauter",
      L"Segue lo scorrimento \u00B7 clic per saltare" },
    { "browser.folders",
      L"ORDNER",
      L"DOSSIERS",
      L"CARTELLE" },
    { "browser.files",
      ...
      L"FILE" },
    { "browser.counts",
      L"%d Ordner \u00B7 %d Dateien",
      L"%d dossiers \u00B7 %d fichiers",
      L"%d cartelle \u00B7 %d file" },
    { "browser.hint",
      L"Enter \u00F6ffnet \u00B7 R\u00FCcktaste hoch",
      L"Entr\u00E9e ouvre \u00B7 Retour remonte",
      L"Invio apre \u00B7 Backspace su" },
    { "browser.naming_folder",
      L"Neuer Ordner wird benannt\u2026",
      L"Nom du nouveau dossier\u2026",
      L"Nome della nuova cartella\u2026" },
    { "browser.naming_file",
      L"Neue Datei wird benannt\u2026",
      L"Nom du nouveau fichier\u2026",
      L"Nome del nuovo file\u2026" },
    { "browser.naming_hint",
      L"Enter erstellt \u00B7 Esc bricht ab",
      L"Entr\u00E9e cr\u00E9e \u00B7 \u00C9chap annule",
      L"Invio crea \u00B7 Esc annulla" },
    { "settings.shortcuts",
      L"Tastaturprofil",
      L"Raccourcis clavier",
      L"Scorciatoie da tastiera" },
